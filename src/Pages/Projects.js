...
class Projects extends Component{
    ...
    <p style={{fontSize:40}}>During my sparetime, I love...<br></br>
    <p style={{fontSize:30}}>...working on my personal projects.<br></br>
                             ...creating things that can make my life easier.<br></br>
                             ...coding and building electronics devices.</p>
                             <p style={{marginTop:50, marginBottom:50,textAlign:'center'}}>↓ Today, I am sharing it with you! 👐 ↓</p></p></div>
        <div style={{ flexDirection:'row',display:"flex", paddingBottom:100}}>
