...
class Home extends Component{
  render() {
    ...
    <p style={{fontSize:30}}> Welcome to my personal website.<br></br>
If you want to check my projects, you are at the right place.<br></br><br></br>

I also recently started to write about my journey as a software engineer, give it a look & let me know what you think of it.<br></br><br></br>
