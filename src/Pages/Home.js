    ...
    render() {
        if (this.state.screenWidth > 1400) {
            return ( <
                ...
                /div> <
                div style = {
                    { backgroundColor: '#F5F5F5', textAlign: 'center', padding: 20, font: 'Montserrat', fontSize: 30 } } > You asked
                for it on Instagram, here is the video of how I(we) fixed the screen.😊 <
